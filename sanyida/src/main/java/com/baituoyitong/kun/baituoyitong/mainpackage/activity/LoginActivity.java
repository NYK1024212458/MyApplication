...
import com.baituoyitong.kun.baituoyitong.mainpackage.utils.ShareUtils;
import com.baituoyitong.kun.baituoyitong.mainpackage.view.CustomDialog;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //注册按钮
    private Button btn_registered,text_registered_phone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        // 获取sp
        commonSPHelper = new CommonSPHelper(LoginActivity.this);
    }
    ...
    private void initView() {
        ...
        text_registered_phone = (Button) findViewById(R.id.text_registered_phone);
        text_registered_phone.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_registered:
                ...
                break;
            case R.id.text_registered_phone:
                startActivity(new Intent(this, RegisteredActivityPhone.class));
                break;
            case R.id.btnLogin:
                //1.获取输入框的值
                               ...
                               /* //判断电话号码
                                ...
                                if (user.getEmail()!=null){
                                    ...
                                    if (user.getEmailVerified()) {
                                        ...
                                        commonSPHelper.saveUserId(user.getObjectId());
                                        finish();
                                    } else {
