	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (null == convertView) {
			convertView = mInflater.inflate(
					R.layout.layout_device_list_item_more, null);

			holder = new ChildViewHolder();
			
			holder.txtDevType = (TextView) convertView.findViewById(R.id.txtDevType);
			holder.txtDevMac = (TextView) convertView
					.findViewById(R.id.txtDevMac);
			holder.txtDevSn = (TextView) convertView
					.findViewById(R.id.txtDevSn);
			holder.txtDevIp = (TextView) convertView
					.findViewById(R.id.txtDevIp);
			holder.txtDevStatusMore = (TextView) convertView
					.findViewById(R.id.txtDevStatusMore);
			
			holder.btnRename = (Button) convertView
					.findViewById(R.id.btnDevRename);
			holder.btnConnect = (Button) convertView
					.findViewById(R.id.btnDevConnect);
			holder.btnControl = (Button) convertView
					.findViewById(R.id.btnDevControl);
			holder.btnAlarm = (Button) convertView
					.findViewById(R.id.btnDevAlarm);
			holder.btnTransCom = (Button) convertView
					.findViewById(R.id.btnDevTransCom);
			holder.btnRemove = (Button) convertView
					.findViewById(R.id.btnDevRemove);
